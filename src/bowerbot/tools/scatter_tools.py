...
_ASSETS = {
    ...
    "minItems": 1,
    "description": (
        "The asset mix. Each item: { asset: the asset's name as search_assets "
        "reports it (e.g. 'pebble'; its library location when two share a name; "
        "file paths are refused), weight?: relative "
